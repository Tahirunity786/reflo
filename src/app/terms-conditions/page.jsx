      ...
      <div className="bg-gray-100 rounded-lg  md:p-12 p-8">
        ...
        <div className="prose prose-gray  max-w-none">
          ...
          <section className="mb-8">
            ...
            <div className="bg-indigo-50 rounded-lg mb-4 p-6">
              <ul className="space-y-2">
                <li>
                  <strong className="text-indigo-700">Company:</strong> DoorBix.
                </li>
                <li>
                  <strong className="text-indigo-700">User:</strong> Any individual who accesses
                  or uses our website or services.
                </li>
                <li>
                  <strong className="text-indigo-700 ">Service:</strong> All Niche Products are available here.
                  provided through our site.
                </li>
                <li>
                  <strong className="text-indigo-700">Content:</strong> All text, images, videos,
                  and other materials.
                </li>
              </ul>
            </div>
          ...
          <section className="mb-8">
            ...
            <div className="md:grid-cols-2 grid gap-6">
              ...
              <div className="bg-gray-50  rounded-lg p-6">
                <p className="text-lg font-semibold text-gray-900 mb-3">Permitted Uses</p>
              ...
              {/* Prohibited Uses */}
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="text-lg font-semibold text-gray-900 mb-3">Prohibited Uses</p>
                <ul className="text-sm space-y-2">
                  <li className="flex items-start">
          ...
          <section className="mb-8">
            <div className="space-y-4">
              <p className="text-2xl font-semibold text-gray-900 pb-2 border-b-2 border-indigo-500">
                1. Further Details
              </p>
          ...
          <div className="mt-12 mb-8 pt-8 border-t border-gray-200">
            <div className="bg-indigo-50 rounded-lg p-6">
              <p className="text-lg font-semibold text-indigo-800 mb-3">Acknowledgment</p>
