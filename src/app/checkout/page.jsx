                ...
                <div className=" dark:bg-gray-800 space-y-6">
                    <div className="bg-white shadow-sm p-6 rounded-lg">
                        <div className="flex items-center space-x-4">
                            <div className="relative">
                                <img src="https://placehold.co/60x60/e5e7eb/6b7280?text=Dress" alt="Short studded denim dress" className="w-15 h-15 object-cover rounded-md" />
                            ...
                            <div className="flex-1">
                                <p className="text-sm font-medium text-gray-900 dark:text-white">Short studded denim dress</p>
                                <p className="text-sm text-gray-500 dark:text-gray-400">S / Purple</p>
                            </div>
                            <div className="text-sm font-medium text-gray-900 dark:text-white">$400.00</div>
                        </div>

                        <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-2 text-sm">
                            <div className="flex justify-between">
                                <span className="text-gray-600 dark:text-gray-400">Subtotal</span>
                                <span className="text-gray-900 dark:text-white">$400.00</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-gray-600 dark:text-gray-400">Shipping</span>
                                <span className="text-gray-500 dark:text-gray-400">Enter shipping address</span>
                            </div>
                        </div>
                        ...
                        <div className="pt-4 border-t border-gray-200 dark:border-gray-700 flex justify-between text-lg font-semibold">
                            ...
                            <div className="text-right">
                                ...
                                <span className="ml-1 text-gray-900 dark:text-white">$400.00</span>
                            </div>
                        </div>
                    </div>
                </div>
