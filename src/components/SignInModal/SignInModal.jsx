...
const SignInModal = ({ isOpen, onClose, onSwitchToSignUp }) => {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/50 transition-opacity duration-300">
      <div className="bg-white rounded-2xl w-full max-w-md p-8 relative shadow-lg transform transition-all duration-300 ease-out scale-95 opacity-0 animate-[fadeInScale_0.3s_ease-out_forwards]">
        {/* Close button */}
        <button
          onClick={onClose}
