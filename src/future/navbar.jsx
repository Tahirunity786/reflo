  ...
  return (
    <>
      <header className="w-full">
        ...
        <div className=" bg-black" ref={topBarRef}>


          <div

            className="max-w-7xl mx-auto text-white text-sm flex justify-between items-center px-4 lg:px-8 py-2"
          >
        ...
        <div className={` bg-white transition-all ${isMainFixed ? "fixed left-0 right-0 z-[100] shadow-sm" : "relative"}`} ref={mainNavRef} style={isMainFixed ? { top: isTopBarFixed ? topBarHeight : 0 } : {}}>
